...
public partial class @PegaInputActions: IInputActionCollection2, IDisposable
{
    ...
    ~@PegaInputActions()
    {
        UnityEngine.Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, PegaInputActions.Player.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_UiControls.enabled, "This will cause a leak and performance issues, PegaInputActions.UiControls.Disable() has not been called.");
    }
